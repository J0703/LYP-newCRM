...
public class ReferAction extends ActionSupport implements ModelDriven<Refer> {
    ...
    @Autowired
    @Qualifier("course_typeService")
    private Course_typeService courseTypeService;
    @Autowired
    ...
    private Refer refer;
    private List<Course_type> courseTypes;
    ...
    public String update() {
        ...
        Course_type courseType = courseTypeService.findSingle(Course_type.class, courseTypeId);
        ...
        if (classId.equals("-1")) {
            ...
            refer.setCourseType(classes.getLessonTypeID());
        }
    ...
    public String add() {
        ...
        if (classId.equals("-1")) {
            ...
            referDriven.setCourseType(classes.getLessonTypeID());
        }
        Crm_staff staff = (Crm_staff) ServletActionContext.getRequest().getServletContext().getAttribute("adminStaff");
    ...
    public void setCourseTypes(List<Course_type> courseTypes) {

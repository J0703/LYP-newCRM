...
public class Refer {
    ...
    private Course_type courseType; //意向学科
    ...
    public Refer(String referId, String name, String telephone, String qq, Date createDate, String intentionLevel, Course_type courseType, Classes classes, String source, String status, String remark, Crm_staff staff) {

...
<table width="100%" border="1">
    ...
    <%--${pb.beanList.depName}--%>
    <%--${pb.beanList.depID}--%>
    <%--<s:property value="#attr.pb.beanList.depName"/>--%>
    <%--<s:property value="#application.pb.beanList.depName"/>--%>
    <%--<s:property value="#session.pb.beanList.depName"/>--%>
    <%--<s:property value="#parameters.pb.beanList.depName"/>--%>
